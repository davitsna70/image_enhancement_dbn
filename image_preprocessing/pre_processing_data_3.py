...
from .noise_generator_3 import noise_generator
...
def get_and_seperate_data_X_y(directory, dimension, modes_convolution = None):
    ...
    for dir_file in dir_list:
        ...
        noise_image = noise_generator(origin_image).astype(np.uint8)
...
for dimension in dimensions:
    ...
    np.save("data_dim_"+str(dimension)+"_noise_2_save.npy",dataset_type_numpy)
